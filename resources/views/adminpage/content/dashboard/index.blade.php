...
<body class="d-flex flex-column min-vh-100" style="background-color: #e5f0e5; overflow-x: hidden;">
    ...
    <div class="d-flex flex-grow-1">
        ...
        <div id="sidebar" class="bg-success text-white p-3 position-fixed top-0 start-0 vh-100" 
            ...
            <ul class="nav flex-column gap-2">
                <li class="nav-item"><a href="{{ route('admin.customers.index') }}" class="btn btn-success text-start w-100"><i class="fa-solid fa-users me-2"></i> Kelola Pelanggan</a></li>
                <li class="nav-item"><a href="{{ route('admin.products.index') }}" class="btn btn-success text-start w-100"><i class="fa-solid fa-box me-2"></i> Kelola Produk</a></li>
                <li class="nav-item"><a href="{{ route('admin.service_status.index') }}" class="btn btn-success text-start w-100"><i class="fa-solid fa-tools me-2"></i> Kelola Status Service</a></li>
                <li class="nav-item"><a href="{{ route('admin.notifikasi.index') }}" class="btn btn-success text-start w-100"><i class="fa-solid fa-bell me-2"></i> Kelola Notifikasi</a></li>
                <li class="nav-item"><a href="{{ route('admin.pesanan.index') }}" class="btn btn-success text-start w-100"><i class="fa-solid fa-clipboard-list me-2"></i> Kelola Pesanan</a></li>
                <li class="nav-item"><a href="{{ route('admin.admin.pendapatan.index') }}" class="btn btn-success text-start w-100"><i class="fa-solid fa-money-bill-wave me-2"></i> Kelola Pendapatan</a></li>
            </ul>
        </div>
        ...
        <div class="flex-grow-1" id="mainContent" style="margin-left: 0;">
            <!-- Navbar -->
            <nav class="navbar navbar-expand-lg navbar-dark bg-success px-3 sticky-top" style="z-index: 1050;">
            ...
            <div class="container-fluid py-4">
                <div class="card shadow text-center w-100 mx-auto" style="max-width: 900px;">
                    <div class="card-body">
